...
def _setoran_list_embed(data: dict, footer: str) -> discord.Embed:
    ...
    for i, e in enumerate(sorted_entries, start=1):
        ...
        jumlah = e["jumlah"]
        total += jumlah
        rows.append(f"{i:>2}. {nama:<{NAME_WIDTH}} {jumlah:>8.0f} kg")
